...
const PersonalInfo = defineAsyncComponent(
  () => import("@/components/Careers/StepPersonal.vue"),
);
const Education = defineAsyncComponent(
  () => import("@/components/Careers/StepEducation.vue"),
);
const Experience = defineAsyncComponent(
  () => import("@/components/Careers/StepExperience.vue"),
);
const Skills = defineAsyncComponent(
  () => import("@/components/Careers/StepSkills.vue"),
);
const Motivations = defineAsyncComponent(
  () => import("@/components/Careers/StepMotivations.vue"),
);
const Documents = defineAsyncComponent(
  () => import("@/components/Careers/StepDocuments.vue"),
);
const Declarations = defineAsyncComponent(
  () => import("@/components/Careers/StepDeclarations.vue"),
);
