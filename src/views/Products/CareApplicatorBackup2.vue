...
<template>
  <div class="relative w-full overflow-hidden">
    ...
    >
      <div></div>
      <div class="grid grid-cols-4 border rounded-lg overflow-hidden text-sm">
        <!-- header -->
        <div class="w-full h-auto flex items-center p-3">
          <span class="text-[18px] text-[#374151] font-[600]">
            Fitur & Parameter
          </span>
        </div>
        <div class="w-full h-auto flex items-center p-3">
        ...
        <div class="w-full h-auto flex items-center p-3 bg-green-600">
          <span>
            Paling Populer <br />
            Core
          </span>
        ...
        <!-- rows -->
        <div class="p-3 border-t">Harga</div>
        <div class="p-3 border-t">Rp 150.000</div>
        <div class="p-3 border-t">Rp 250.000</div>
        <div class="p-3 border-t">Rp 300.000</div>
