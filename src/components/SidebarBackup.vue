        ...
        <div class="ml-auto w-full h-auto px-4 py-6 z-50">
          ...
          >
            ...
            >
              ...
              <div class="w-full h-[2px] bg-[#1AB24F]/40" />
              <div class="w-full h-auto flex flex-col">
                <p class="text-slate-400 text-[16px] font-[400]">Products</p>
                <div class="w-full h-auto flex flex-wrap">
                  <div
              ...
              <div class="w-full h-[2px] bg-[#1AB24F]/40" />
              <div class="w-full h-auto flex flex-col">
                <p class="text-slate-400 text-[16px] font-[400]">Technology</p>
                <div class="w-full h-auto flex flex-wrap">
                  <div
              ...
              <div class="w-full h-[2px] bg-[#1AB24F]/40" />
              <div class="w-full h-auto flex flex-col">
                <p class="text-slate-400 text-[16px] font-[400]">Solutions</p>
