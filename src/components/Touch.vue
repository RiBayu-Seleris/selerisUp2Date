  ...
  <div class="lg:mt-0">
    ...
    >
      <div class="flex flex-row w-full h-auto gap-5">
        <div
          class="w-[45%] lg:h-[530px] xl:h-[580px] p-[1px] bg-[#D9D9D9] dark:bg-gradient-to-tr dark:from-[#17181A] dark:from-45% dark:to-[#565656] shadow-lg rounded-3xl"
        >
          <div
            class="w-full h-full bg-[#FAFAFA] dark:bg-[#323232] rounded-3xl py-3 lg:px-5 xl:px-7"
          >
        ...
        >
          <div
            class="flex w-full lg:h-[60%] xl:h-[65%] p-[1px] bg-[#D9D9D9] dark:bg-gradient-to-tr dark:from-[#17181A] dark:from-45% dark:to-[#565656] shadow-lg rounded-3xl"
          >
            <div
              class="flex w-full h-full bg-[#FAFAFA] dark:bg-[#323232] rounded-3xl p-3"
            >
          ...
          <div class="flex flex-row w-full lg:h-[40%] xl:h-[35%] gap-5">
            <div
              class="w-full h-full p-[1px] bg-[#D9D9D9] dark:bg-gradient-to-tr dark:from-[#17181A] dark:from-45% dark:to-[#565656] shadow-lg rounded-xl"
            >
              <div
