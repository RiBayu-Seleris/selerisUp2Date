...
<template>
  ...
  >
    ...
    <div
      ...
      :class="[
        isScrolled
          ? 'w-auto h-auto rounded-[10px] p-[1px] bg-[#D9D9D9] dark:bg-gradient-to-tr dark:from-[#17181A] dark:from-45% dark:to-[#565656]'
          : 'bg-transparent',
      ]"
    >
      <div
        ...
        :class="[
          isScrolled
            ? 'bg-white/70 py-2 xls:px-8 2xls:px-14 rounded-[10px] backdrop-blur-lg dark:bg-black/40 dark:backdrop-blur-3xl'
            : 'bg-transparent',
        ]"
      >
