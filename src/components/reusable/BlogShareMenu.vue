<script setup>
import FrameShare from "@/components/icons/FrameShare.vue";
</script>
...
<template>
  ...
  <div class="relative w-full h-full">
    <!-- SVG frame -->
    <FrameShare class="w-full h-full" />
    ...
    >
      ...
      >
        ...
        <div class="w-full h-auto flex items-center">
          <p class="hidden md:inline-block">Share on X</p>
          <p class="inline-block md:hidden">Twitter</p>
        </div>
      </button>
    </div>
  </div>
