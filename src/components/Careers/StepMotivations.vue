...
const wrapperStartDate = ref(null);
...
const handleClickOutside = (e) => {
  if (!wrapperStartDate.value) return;

  if (!wrapperStartDate.value.contains(e.target)) {
