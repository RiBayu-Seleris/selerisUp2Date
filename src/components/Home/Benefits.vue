...
<template>
  <div class="flex flex-col relative w-full">
    ...
    <div class="relative w-full h-auto">
      ...
      />
      <div
        class="relative flex flex-row w-full max-h-screen gap-x-5 md:gap-x-5 lg:gap-x-10 mt-16 sml:mt-4 md:mt-5 py-5 overflow-x-auto snap-x snap-mandatory sml:pl-10 sml:pr-10 md:pl-16 md:pr-16 xl:pl-32 xl:pr-16 hide-scrollbar"
      >
        <CardDefault
