    ...
    data: [
      {
        ...
        description: `Seleris Credit Cover is an AI-powered platform designed to streamline your business operations
		 	by offering intelligent automation and seamless data integration. With a user-friendly interface and
		  	smart, real-time analytics, Seleris Credit Cover empowers teams to make better decisions faster,
		  	scale effortlessly, and enhance operational efficiency. Whether you're managing workflows, analyzing customer behavior,
			or integrating tools, Seleris gives you the power to turn insights into impact.`,
        content: [
          {
            title: "Connect your favorite tools in minutes.",
            description: `Seleris Credit Cover integrates with a wide range of third-party apps to help you unify all your business data in one place. 
      ...
      },
      {
        ...
        description: `Seleris Medins is a health insurance intelligence platform powered by AI that automates the processing of medical data, enhances fraud detection, and improves cost and risk prediction while ensuring compliance with local health regulations. 
		  	...
		  	the platform integrates predictive analytics and real-time automation to support faster claims management, better risk stratification, and more personalized underwriting.
			With its intuitive interface, users can complete their insurance evaluation in a single, efficient workflow.`,
        content: [
          {
